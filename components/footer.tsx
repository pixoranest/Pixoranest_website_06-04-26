...
// FIX: SVG icons kept as-is (inline SVGs are fine — no extra network requests)
...
export function Footer() {
  ...
  return (
    // FIX: Added role="contentinfo" — correct semantic role for page footer
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            {/* FIX: Replace <img> with Next.js <Image> for automatic lazy loading + size hints */}
            <Image
              ...
              // FIX: Footer logo is below fold — lazy load
              loading="lazy"
            />
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              effort. Trusted by growing businesses across India to automate
              workflows and increase efficiency.
            </p>

            {/* Social links */}
            <div className="flex items-center gap-2 flex-wrap" aria-label="PixoraNest on social media">
              {allFooterSocials.map((social) => {
                ...
                return Icon ? (
                  <a
                    ...
                    aria-label={`Follow PixoraNest on ${social.label}`}
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <a
                  ...
                  className="text-sm text-muted-foreground transition-colors hover:text-primary"
                  aria-label="Email PixoraNest at info@pixoranest.com"
                >
                  {/* FIX: Plain text email — remove HTML entity obfuscation,
                      it hurts readability and modern spam filters don't care */}
                  info@pixoranest.com
                </a>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <a
                  ...
                  className="text-sm text-muted-foreground transition-colors hover:text-primary"
                  aria-label="Call PixoraNest at +91 94606 86266"
                >
                  +91 94606 86266
                </a>
              </div>
        ...
        {/* ── SEO Internal Links (Link Building) ── */}
        {/* FIX: Footer internal links pass equity to service pages — fixes the F grade */}
        <nav
          aria-label="PixoraNest AI services navigation"
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-2 sm:grid-cols-3 lg:grid-cols-5">
            ...
            <Link href="/solutions" className="text-xs text-muted-foreground hover:text-primary transition-colors">
              All AI Solutions
            </Link>
          </div>
        </nav>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-border pt-6 sm:flex-row">
          <div className="text-center sm:text-left">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} PixoraNest. All rights reserved.
            </p>
