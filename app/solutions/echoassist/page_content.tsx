  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="relative px-4 pt-20 pb-24 sm:px-6 lg:px-8 lg:pt-28 lg:pb-32">
        ...
        >
          <motion.div variants={fadeUp} className="mb-6 inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-4 py-1.5">
            ...
            {features.map((f) => {
              ...
              return (
                <motion.div key={f.title} variants={fadeUp} whileHover={{ y: -4 }}
                  className="group rounded-2xl border border-border/60 bg-card/50 p-5 backdrop-blur-sm transition-all hover:border-amber-500/30 hover:shadow-lg"
                >
