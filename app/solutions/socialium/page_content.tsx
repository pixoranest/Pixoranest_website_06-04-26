        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="stagger-container grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => {
              ...
              return (
                <div key={f.title}
                  className="group rounded-2xl border border-border/60 bg-card/50 p-5 backdrop-blur-sm transition-all hover:border-violet-500/30 hover:shadow-lg hover:-translate-y-1"
                >
