  ...
  return (
    <main className="overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="stagger-container grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {features.map((f) => {
              ...
              return (
                <div key={f.title}
                  className="group rounded-2xl border border-border/60 bg-card/50 p-5 backdrop-blur-sm transition-all hover:border-sky-500/30 hover:shadow-lg hover:-translate-y-1"
                >
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl font-bold text-foreground sm:text-3xl">Ready to Upgrade from IVR to AI?</h2>
